...
#define SENSORLESS_BACKOFF_MM  { 1, 1, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define LIN_ADVANCE
  ...
  #define ADVANCE_L 0.02    // Add a second linear advance constant, configurable with M900 L.

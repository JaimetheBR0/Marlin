 ...
 */
#define Z_MIN_PROBE_PIN SERVO2_PIN
 ...
 */
#define BLTOUCH
// Yellow wire: SERVO2_PIN (D5)
// White wire: SERVO1_PIN (D6)
#define SERVO0_PIN 6
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, -35, -3 }
...
#define SERVO_DELAY { 300, 300 } // needs 2 because bltouch uses two servo pins

...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 35.49
  #define DEFAULT_bedKi 2.881
  #define DEFAULT_bedKd 291.5
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MAX_POS - 50), 20 }

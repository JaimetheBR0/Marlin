...
#define CUSTOM_MACHINE_NAME "NTML Sidewinder X1"
 ...
 */
#define BLTOUCH
// Yellow wire: SERVO0_PIN (D11)
// White wire: Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN (D18)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 40.0 // (mm) Length of all segments (except the last one)
